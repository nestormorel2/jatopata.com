...
<?php switch($item->asp_f_type) { case "radio": ?>
    ...
    <?php case "dropdown": ?>
        <div class="asp_select_label<?php echo w_isset_def($item->asp_f_dropdown_multi, 'asp_unchecked') == 'asp_checked'?' asp_select_multiple':' asp_select_single'; ?>">
            <select <?php echo w_isset_def($item->asp_f_dropdown_multi, 'asp_unchecked') == 'asp_checked'?' multiple name="aspf['.$_field_name.'][]"':'name="aspf['.$_field_name.']"'; ?> >
    ...
    <?php case "checkboxes": ?>
        ...
        <?php foreach($item->asp_f_checkboxes_value as $checkbox): ?>
            ...
            <div class="asp_option">
                ...
                <div class="label"><?php echo str_replace('**', '', $checkbox[1]); ?></div>
            </div>
        <?php endforeach; ?>
    <?php break; ?>
    <?php
