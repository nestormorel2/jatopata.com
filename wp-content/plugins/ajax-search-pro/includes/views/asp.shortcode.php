...
?>
<div class='wpdreams_asp_sc wpdreams_asp_sc-<?php echo $real_id; ?> ajaxsearchpro asp_main_container <?php echo $extra_class; ?>'
...
<div id='ajaxsearchprobsettings<?php echo $id; ?>' class="wpdreams_asp_sc wpdreams_asp_sc-<?php echo $real_id; ?> ajaxsearchpro searchsettings">
<?php else: ?>
    <div id='ajaxsearchprosettings<?php echo $id; ?>' class="wpdreams_asp_sc wpdreams_asp_sc-<?php echo $real_id; ?> ajaxsearchpro searchsettings">
<?php endif;
