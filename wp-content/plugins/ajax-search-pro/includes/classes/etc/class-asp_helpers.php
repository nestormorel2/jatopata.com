...
if (!class_exists("ASP_Helpers")) {
    ...
    class ASP_Helpers {
        ...
        public static function getCFValue($field, $r, $use_acf = false, $args = array()) {
            ...
            if ( in_array($field, array('_price', '_sale_price', '_regular_price')) &&
                isset($r->post_type) &&
        ...
        public static function woo_formattedPriceWithCurrency($id, $field, $args) {
            ...
            if ( isset($woocommerce_wpml, $woocommerce_wpml->multi_currency) ) {
                $price = $woocommerce_wpml->multi_currency->prices->get_product_price_in_currency($id, $currency);
            } else {
                // For variable products, display the range
