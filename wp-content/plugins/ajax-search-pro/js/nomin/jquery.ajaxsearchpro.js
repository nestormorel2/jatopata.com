    ...
    var methods = {
        ...
        initMagnifierEvent: function () {
            ...
            $this.n.promagnifier.add($this.n.text).bind('click keyup', function (e) {
                ...
                if ( $this.ktype != 'click' && $this.ktype != 'keyup' ) return;
                ...
                if (
                    ...
                    if ( source == 'results_page' ) {
                        ...
                        var url = $this.o.redirect_url.replace('{phrase}', asp_nice_phrase( $this.n.text.val() ));
                    }
        ...
        isRedirectToFirstResult: function() {
            ...
            if (
                ...
                ($this.o.redirect_on_enter == 1 && $this.ktype == 'keyup' && $this.keycode == 13 && $this.o.redirectEnterTo == 'first_result' )
            ) {
                return true;
            }
            return false;
                        ...
                        $('a', $this.n.showmore).on('click', function(e){
                            ...
                            if ( $this.o.show_more.action == "ajax") {
                                ...
                                if ( $this.o.show_more.action == 'results_page' ) {
                                    ...
                                    var url = $this.o.show_more.url.replace('{phrase}', asp_nice_phrase($this.n.text.val()));
        ...
        resize: function () {
            ...
            if ($this.n.prosettings.data('opened') != 0 && $this.o.blocking != true) {
                ...
                if ($this.o.settingsimagepos == 'left') {
                    $this.n.searchsettings.css({
                        display: "block",
                        top: _node.offset().top + _node.height() - 2 - bodyTop,
                    ...
                    $this.n.searchsettings.css({
                        display: "block",
                        top: _node.offset().top + _node.height() - 2 - bodyTop,
                        left: _node.offset().left + _node.width() - $this.n.searchsettings.width()
                    });
                }

                $this.fixSettingsWidth();
            }
            if ($this.n.resultsDiv.css('visibility') != 'hidden' && $this.n.resultsDiv.css('position') == 'absolute') {
        ...
        searchRedirect: function( phrase ) {
            ...
            if ( typeof instData[rid] != 'undefined' ) {
                var $this = instData[rid];
                var url = $this.o.redirect_url.replace('{phrase}', asp_nice_phrase(phrase));
