...
<?php if ($use_compatibility == true): ?>
    ...
    <?php echo $asp_bset_ids1; ?>.searchsettings .option label:after,
    <?php echo $asp_bset_ids2; ?>.searchsettings .option label:after,
<?php endif; ?>
<?php echo $asp_bset_ids; ?>.searchsettings .option label:after,
