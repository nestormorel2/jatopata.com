...
define('THE_CHAMP_SS_VERSION', '7.12.18');
...
function the_champ_save_default_options(){
	...
	add_option('the_champ_sharing', array(
	   ...
	   'horizontal_re_providers' => array( 'facebook', 'twitter', 'google_plus', 'linkedin', 'pinterest', 'reddit', 'MeWe', 'mix', 'whatsapp' ),
	   ...
	   'vertical_re_providers' => array( 'facebook', 'twitter', 'google_plus', 'linkedin', 'pinterest', 'reddit', 'MeWe', 'mix', 'whatsapp' ),
	   'vertical_bg' => '',
	   'alignment' => 'left',
	   'left_offset' => '-10',
	   'right_offset' => '-10',
