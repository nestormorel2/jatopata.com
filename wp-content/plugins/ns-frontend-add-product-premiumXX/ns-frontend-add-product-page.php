			...
			<div id="ns-product-data-inner-container" class="ns-border-margin">
				...
				<div class="ns-left-list-data-container">
					<ul>
						...
						<li id="ns-variation" class="ns-hidden"><a href="#ns-prod-variation" class="ns-link">Variations</a></li>
					</ul>
				</div>
		...
		<div class="ns-left ns-little-container">
			...
			?>
				<div id="ns-product-gallery" class="ns-little-box">
					<div>
						<h2 class="ns-center">Product Gallery</h2><span id='ns-prod-gallery-hide-show' class="dashicons dashicons-arrow-down ns-pointer"></span>
					</div>
